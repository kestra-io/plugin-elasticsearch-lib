package io.kestra.plugin.elasticsearch-lib;
    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.elasticsearch-lib.ElasticsearchLibTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class ElasticsearchLibTask extends Task implements RunnableTask<ElasticsearchLibTask.Output> {
    @Schema(
    ...
    @Override
    public ElasticsearchLibTask.Output run(RunContext runContext) throws Exception {
