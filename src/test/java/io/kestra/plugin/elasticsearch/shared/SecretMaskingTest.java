...
class SecretMaskingTest {
    ...
    void headersMustBeMasked() {
        assertSecret(ElasticsearchConnection.class, "headers");
    }

    @Test
    void basicAuthUsernameMustBeMasked() {
        assertSecret(ElasticsearchConnection.BasicAuth.class, "username");
    }

    @Test
    void basicAuthPasswordMustBeMasked() {
        assertSecret(ElasticsearchConnection.BasicAuth.class, "password");
    }
